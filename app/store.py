...
class ConversationStore:
    ...
    def ping(self) -> bool:
        ...
        Trả True nếu Redis phản hồi, False nếu có lỗi kết nối.
        """
        try:
    ...
    def append(
        ...
        # Thêm message mới vào cuối Redis List
        self.client.rpush(
            key,
            message,
        )

        # Chỉ giữ HISTORY_MAX_MESSAGES message mới nhất
        self.client.ltrim(
            key,
        ...
        # Conversation tự hết hạn sau HISTORY_TTL_SECONDS
        self.client.expire(
            key,
            HISTORY_TTL_SECONDS,
        )
